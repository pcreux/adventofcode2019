...
class Wire
  ...
  def L!
    points << Point.new(current_point.x - 1, current_point.y)
  end
  ...
  def D!
    points << Point.new(current_point.x, current_point.y - 1)
  end
...
def closest_to_central_port(wire1, wire2)
